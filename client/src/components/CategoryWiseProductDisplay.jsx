  ...
  return (
    <div>
      <div className="container mx-auto p-4 flex items-center justify-between gap-4">
        ...
        <Link
          to={redirectURL}
          className="text-red-600 hover:text-red-400 font-normal"
        >
          See All
        </Link>
      </div>
      <div className="relative flex items-center ">
        ...
        <div className="w-full left-0 right-7 container mx-auto px-2  absolute hidden lg:flex justify-between">
          <button
