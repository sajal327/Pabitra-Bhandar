    ...
    <div className="">
      <div className="bg-white shadow-lg px-2 py-2 flex justify-between gap-4 items-center ">
        ...
        <button
          ...
          className="border border-red-600 text-black px-3 font-light hover:bg-red-700 hover:text-white py-1 rounded-full"
        >
          Add Address
        </button>
      </div>
      <div className="bg-gray-200 p-2 grid gap-4">
        ...
        <div
          onClick={() => setOpenAddress(true)}
          className="h-16 bg-gray-100 border-2 border-gray-100 border-solid  flex justify-center text-lg font-normal items-center cursor-pointer"
        >
          Add address
        </div>
      </div>
